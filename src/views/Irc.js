...
export default class IRC extends Transcendence {
    ...
    render() {
            ...
            <div id=wrapper class=wrapper>
                <div id=projectCanva class="projectCanva bordered label">
                    <div id=projectName class="projectName bordered label">IRC</div>
    ...
    attachFeatureEvents(featureName){
        ...
        prevButton.addEventListener('click', () => {
            if (currentFeatureIndex > 0) {
                ...
                console.log("length :" ,this.projects[2].features.length);
                const lastFeatureIndex = this.projects[2].features.length - 1;
                this.renderFeature(this.projects[2].features[lastFeatureIndex]);
            }
        });
        nextButton.addEventListener('click', () => {
            if (currentFeatureIndex < this.projects[2].features.length - 1) {
                ...
                this.renderFeature(this.projects[2].features[0]);
            }
        });
    ...
    mount() {
        const IRCProject = this.projects.find(project => project.name === "IRC:");
        this.renderProject();
        this.renderFeature(IRCProject.features[0]);
    }
